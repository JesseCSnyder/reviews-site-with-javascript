...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Review phantomSurfers = new Review("The Phantom Surfers", surfRevival, "/images/phantomSurfers.jpg",
				"The Phantom Surfers are a surf rock band formed in 1988. - Wikipedia");
		reviewRepo.save(phantomSurfers);
		Review apeMen = new Review("The Ape Men", surfRevival, "/images/apeMen.jpg",
				"The Apemen is a Dutch surf rock band, comprising band-members from Tilburg and Rotterdam, with their base remaining in Tilburg. - Wikipedia");
		reviewRepo.save(apeMen);
		Review bauhaus = new Review("Bauhaus", postPunk, "/images/bauhaus.jpg",
				"Bauhaus were an English post-punk band, formed in Northampton, England in 1978. - Wikipedia");
		reviewRepo.save(bauhaus);
		Review minuteMen = new Review("The Minutemen", postPunk, "/images/minuteMen.jpg",
				"Minutemen were an American punk rock band formed in San Pedro, California in 1980. - Wikipedia");
		reviewRepo.save(minuteMen);
		Review devo = new Review("Devo", postPunk, "/images/devo.jpg",
				"Devo is an American rock band that formed in 1973, consisting of members from Kent and Akron, Ohio. - Wikipedia");
